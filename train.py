...
def tester(filepath, model, param_grid, scoring=make_scorer(f1_score, average='weighted'), cv=10, top_n=5):
...
def knn():
    filepath = os.path.join(results_folder, "knn_results2.txt")
    ...
    tester(model=KNeighborsClassifier(), param_grid=knn_param_grid, filepath=filepath)
...
# print("\nIniciando testes do Random Forest\n")
# t0 = time.perf_counter()
# tester(RandomForestClassifier(), forest_grid)
# t1 = time.perf_counter()
# print("\nTempo decorrido (Random Forest): {:.2f} segundos\n".format(t1 - t0))

# print("\nIniciando testes do SVM\n")
# t0 = time.perf_counter()
# tester(SVC(), svm_grid)
# t1 = time.perf_counter()
# print("\nTempo decorrido (SVM): {:.2f} segundos\n".format(t1 - t0))

# print("\nIniciando testes do MLP\n")
# t0 = time.perf_counter()
# tester(MLPClassifier(), mlp_grid)
# t1 = time.perf_counter()
# print("\nTempo decorrido (MLP): {:.2f} segundos\n".format(t1 - t0))
